...
assert_success_with_output output git perf audit --filter "^perf_" -d 10
...
assert_success_with_output output git perf audit --filter "through" -d 10
...
assert_failure_with_output output git perf audit -d 10
