...
\`\[audit.measurement."name"\].min_relative_deviation = 10.0\` - Global:
...
Method for calculating statistical dispersion (stddev or mad). If not
specified, uses the value from .gitperfconfig file, or defaults to
stddev  
