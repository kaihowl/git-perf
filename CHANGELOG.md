...
## [0.16.0](https://github.com/kaihowl/git-perf/compare/v0.15.5...v0.16.0) - 2025-03-01
...
- accept expected perf regression from b935a401 (#122)
- report size changed independent of changes (#121)
- set CI to true (#118)
