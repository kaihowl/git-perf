...
/// 2. Delegates to specialized functions based on show_epochs and detect_changes flags
///
/// # Arguments
    ...
    F: Fn(&str) -> crate::change_point::ChangePointConfig,
{
    ...
    if params.detect_changes {
        add_change_point_traces(reporter, &params, &prepared, change_point_config_fn);
    }
}
