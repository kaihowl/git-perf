...
/// Returns the maximum CoV (Coefficient of Variation = σ/μ × 100%) threshold from config,
/// or None if not set. When tail or head CoV exceeds this value, a warning is emitted.
#[must_use]
