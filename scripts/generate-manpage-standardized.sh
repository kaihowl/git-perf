...
echo "🔧 Generating manpage.md with standardized pandoc configuration..."
...
echo "✅ Successfully generated docs/manpage.md with standardized formatting"
...
echo ""
echo "💡 This version uses standardized pandoc options to match CI expectations"